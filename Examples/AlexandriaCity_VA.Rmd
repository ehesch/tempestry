...
raw_daily_temps <- fxn_fetch_daily_stations(
  .site_latitude = 38.80273294717483,
  .site_longitude = -77.04731396319815,
...
https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/county/time-series/VA-510/tavg/12/12/1895-2023

### Plot annual data

```{r}
annual_temps <- fxn_process_annual(.annual_df = "alexandriava_annual.txt")

count(annual_temps, temp_category)

annual_plot <- fxn_plot_annual(annual_temps,
              .label_remove = c("1895", "1901", "1907",  "1926", "2016","2017", "2020", "2021")
              )
...
```{r}
poster <- fxn_make_poster(.title = "Alexandria City, VA") 

ggsave(plot = poster, file.path(here::here(), "Examples/AlexandriaVA.pdf"), 
